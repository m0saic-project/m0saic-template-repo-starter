    ...
    async render(props, ctx) {
        ...
        const barBand = (s) => {
            const cells = s.map((v) => {
                ...
                const bar = String((0, dsl_stdlib_1.weightedSplit)([100 - h, h], "row", { mode: "literal", claimants: ["-", "1"] }));
                return String((0, dsl_stdlib_1.weightedSplit)([1, 8, 1], "col", { claimants: ["-", bar, "-"] }));
            });
            return String((0, dsl_stdlib_1.weightedSplit)(s.map(() => 1), "col", { claimants: cells }));
        };
