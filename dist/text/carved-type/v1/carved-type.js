...
exports.CarvedTypeV1 = (0, template_utils_1.defineMosaicTemplate)({
    ...
    async render(props, ctx) {
        var _a, _b, _c, _d;
        const word = ((_a = props.word) !== null && _a !== void 0 ? _a : "MOSAIC").trim();
        const media = ((_b = props.media) !== null && _b !== void 0 ? _b : "").trim();
        const fallbackColor = (_c = props.fallbackColor) !== null && _c !== void 0 ? _c : "#EF7525";
        const problems = [];
        ...
        const fit = (0, template_utils_1.fitSvgText)(word, tile.width, tile.height, {
        ...
        const mask = {
            kind: "inline-mask",
            localPath: (0, template_utils_1.textToPath)(word, { fontSize: fit.fontSize }, tile),
        ...
        if (media.length > 0) {
            ...
            const meta = ctx.media[(0, types_1.asAssetId)(media)];
            if (!meta) {
                throw new Error(`${ID}: "${media}" has no ctx.media probe - the host found no such file.`);
            }
            if (meta.kind !== "image" && meta.kind !== "video") {
                throw new Error(`${ID}: "${media}" probed as ${(_d = meta.kind) !== null && _d !== void 0 ? _d : "unknown"} - pick an image or a video.`);
            }
            const key = String((0, template_utils_1.slugifyAssetKeyFromPath)(media));
            ...
            carved = (0, template_utils_1.makeColorTile)(fallbackColor, { mask });
...
exports.default = exports.CarvedTypeV1;
