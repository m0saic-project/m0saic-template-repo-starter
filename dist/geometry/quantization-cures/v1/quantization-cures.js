...
exports.QuantizationCuresV1 = (0, template_utils_1.defineMosaicTemplate)({
    ...
    lattice: {
        allow: [
            {
                count: 299,
                reason: "naive ratio gutters on display: 12 cells x 24 + 11 gutters - the rough count the three cures remove",
            },
            {
                count: 167,
                reason: "naive ratio gutters on display: 3 cells x 55 + 2 gutters - the rough count the three cures remove",
            },
        ],
    },
    outputHints: {
