...
export const connectionsRegistry: StarterRegistryEntry[] = [
  ...
  },
  {
    ...
    title: "75 · Options From a Connection",
    description:
  ...
  },
  {
    ...
    title: "76 · Cards Picker",
    description:
      "Pick upstream results by their artwork: picker \"cards\" turns a connection-backed string[] into an image-card grid, cardAspect/cardFit are declared by the template because they describe the connection kind, and the heavy art rides a companion images fetcher — lazy, per visible page, data URIs. At render the prop is a plain string[].",
    tags: ["connections", "lesson"],
  },
  {
    slug: "multi-select",
    ...
    title: "77 · Connection Multi-Select",
    description:
  ...
  },
  {
    ...
    title: "79 · Weighted Cards",
    description:
      "Weights at both depths: a weights column SHARING the multi-select's key gives each card an auto-balancing share group over its own chips (two cells, one array — even sets round-trip string[], customized {id,weight}[]), and interWeightProp names a sibling number[] weighing the cards against each other. Rows and chips in the render ARE those values.",
