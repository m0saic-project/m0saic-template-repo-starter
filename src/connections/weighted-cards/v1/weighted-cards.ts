 ...
 *
 * ONE CONCEPT: the weighted `cardList`. Two declarations extend lesson 74's
...
const propsSchema = definePropsSchema<WeightedCardsProps>({
  connectionId: {
    ...
    required: false,
    description:
      "The sibling wire (lesson 72): which configured connection profile the chip pickers read.",
    meta: {
