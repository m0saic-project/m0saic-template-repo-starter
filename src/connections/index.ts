...
import { CriteriaFilterV1 } from "./criteria-filter/v1/criteria-filter";
...
export const connectionsTemplates: MosaicTemplate<MosaicTemplateProps>[] = [
  ...
  CriteriaFilterV1 as unknown as MosaicTemplate<MosaicTemplateProps>,
...
export * from "./criteria-filter/v1/criteria-filter";
