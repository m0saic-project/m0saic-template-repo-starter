...
export const basicsRegistry: StarterRegistryEntry[] = [
  ...
  },
  {
    ...
    title: "02 · Anatomy",
    description:
      "The smallest correct template, written by hand: the pixel-M in a square cell over a greeting, typed props with deterministic defaults, and a validated m0 string. Every part of a template, visible. The repo's smoke render.",
