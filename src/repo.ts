...
export const TEMPLATE_REPO: MosaicTemplateRepoDescriptor = {
  ...
  helloWorld: asTemplateId("@m0saic-starter/basics/hello-world/v1"),
};
...
export const TEMPLATE_PACKS: MosaicTemplatePackDescriptor[] = [
  ...
  },
  {
    ...
    title: "Geometry",
    description:
      "The m0 geometry contract as runnable lessons: GCD collapse, ratio vs absolute, overlays that restore their node's rect, lattice gutters (both spellings), inset recovery, placeRect docking, masks as fiber, and the three cures for a split the canvas cannot divide.",
  },
  {
    id: "props",
    title: "Props",
  ...
  },
  {
    ...
    title: "Media",
    description:
      "Files, folders, probes, and time: the media prop pipeline, ctx.media as the host's ffprobe registry, the time-range scrubber pair, content-aware analysis with stated fallbacks, playSpeed, the audio mix + mute idiom, and the url-asset trade-off.",
  },
  {
    id: "text",
    title: "Text",
  ...
  },
  {
    ...
    title: "Make",
    description:
      "What Make does with your template once it loads: the rects you draw are bound to the knobs in the panel (bindProp and its siblings), so a double-click on the preview edits the prop in place. Provenance is authored on the source, derived per render, and checked by the build gate.",
  },
];
